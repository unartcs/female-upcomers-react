...
function Instagram() {
  ...
  const fetchData = async () => {
    const response = await fetch(
      `https://graph.instagram.com/me/media?fields=id,caption,media_type,media_url,timestamp,permalink&access_token=${process.env.secrets.REACT_APP_SPOTIFY_CLIENT_SECRET}...`
    );
